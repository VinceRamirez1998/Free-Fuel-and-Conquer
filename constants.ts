...
export const TRANSLATIONS = {
    en: {
        headers: {
            appSubtitle: "Meal Architect Lite",
            heroTitle: "Simple. Effective. Nutrition.",
            heroSubtitle: "Enter your stats. Choose your proteins. Get a 3-day reset plan.",
            loadingTitle: "Engineering Your Plan...",
            loadingSubtitle: "Calibrating macros for maximum performance.",
    ...
    es: {
        headers: {
            appSubtitle: "Arquitecto de Nutrición Lite",
            heroTitle: "Simple. Efectivo. Nutrición.",
            heroSubtitle: "Ingresa tus datos. Elige tus proteínas. Obtén un plan de 3 días.",
